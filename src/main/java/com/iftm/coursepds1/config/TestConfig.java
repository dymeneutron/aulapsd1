...
import com.iftm.coursepds1.entities.OrderItem;
import com.iftm.coursepds1.entities.Payment;
...
import com.iftm.coursepds1.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {  // commandlinerunner servira para implementar o test na aplicação principal
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), u2,OrderStatus.WAITING_PAUMENT);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u1, OrderStatus.WAITING_PAUMENT);
